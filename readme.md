...
Technisch gesehen habe ich mich in verschiedenen Bereichen weiterentwickelt. Besonders stolz bin ich darauf, dass ich das Arbeiten mit Dictionaries gemeistert habe. Es war großartig zu sehen, wie ich dieses Konzept schnell verstanden und in meinen Projekten angewendet habe. Auch die Verwendung von JSON und die Implementierung von "async" und "await" waren Herausforderungen, die ich erfolgreich gemeistert habe, obwohl es anfangs einige Schwierigkeiten gab.

Was die Projekte angeht, habe ich mich nicht auf eine einzige Sache konzentriert, sondern mich verschiedenen Themen gewidmet. Vom Erstellen eines Discord-Bots über die Entwicklung eines einfachen Spiels bis hin zur Verbesserung meiner C#-Kenntnisse habe ich eine breite Palette von Aufgaben angegangen. Selbst wenn nicht alles perfekt lief und es Tage gab, an denen ich mich nicht besonders motiviert fühlte, habe ich trotzdem weitergearbeitet und versucht, das Beste aus jeder Situation zu machen.
...
3. Game Developement; sprich im Sinne von Spiele entwickeln indem man bewegende Figuren oder Charaktäre hat(Abgesehen von meinem Snake-Spiel). Nicht nur 2D sondern auch mal etwas richtung 3D vertraut machen mit 
   CSS und HTML als Beispiel.
